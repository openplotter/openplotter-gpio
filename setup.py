...
from openplotterGpio import version

setup (
	name = 'openplotterGpio',
	version = version.version,
	description = 'OpenPlotter app to get data from GPIO',
	license = 'GPLv3',
	author="Sailoog",
	author_email='info@sailoog.com',
	url='https://github.com/openplotter/openplotter-gpio',
	packages=['openplotterGpio'],
